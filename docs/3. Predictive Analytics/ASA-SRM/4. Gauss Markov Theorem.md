...
Outliers are observations with **unusual values of the DV** relative to majority of the observations.
...
Example from actex: Not unusual in x1 or x2 but unusual when taken collectively
