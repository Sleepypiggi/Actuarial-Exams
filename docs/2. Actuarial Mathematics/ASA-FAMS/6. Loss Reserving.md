...
* **Rows**: **Accident Year** (AY); Year that the accident occurred
* **Columns**: **Development Year** (DY); Year that the claim was paid
* **Diagonals**: **Calendar Year** (CY)
* **Cells**: Incremental losses; loss that was paid in that year
