...
Consider a policy that only has **acquisition and renewal expenses**:
...
It is also known as the **Expense Loading** as it represents the amount that is added (*loaded*) on to the premiums **just to cover expenses**.
