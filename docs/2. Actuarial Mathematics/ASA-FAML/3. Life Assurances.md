...
!!! Warning
    ...
    $$
    \begin{aligned}
        \text{Actual EPV} &= B \cdot E(\text{WL}) \\
        \text{Actual Variance} &= B^2 \cdot \text{Var}(\text{WL})
    \end{aligned}
    $$
...
!!! Tip
    ...
    The SULT table provides values for the EPVs EA and PE with terms of 10 or 20 years. Thus, these values can also be used to calculate the **EPV of a TA with a term of 10 or 20 years**.
