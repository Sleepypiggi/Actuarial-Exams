...
Since the PV is a transformation of the future lifetime variable, the **percentile of the PV is the percentile of the future lifetime variable**, which was covered in the survival model section.
