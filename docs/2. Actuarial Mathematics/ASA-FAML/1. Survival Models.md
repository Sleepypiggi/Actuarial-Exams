...
!!! Warning
    ...
    This result **ONLY applies to the survival function**!

    This result was used in to prove the deferred death probabilities, thus the same warning applies here - do not forget to update the "new" age of the person!
...
!!! Warning
    ...
    Most of the time, we want $\mu_{x+t}$ but the question provides $\mu_{x}$. Need to convert?
