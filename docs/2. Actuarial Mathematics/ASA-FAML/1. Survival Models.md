...
The Survival Model above can be expressed in tabular form, known as a **Life Table**. Instead of providing the probabilities directly, it provides the **expected number of people alive at a given age** $l_x$. From these values, the probability rates can be calculated.
