...
> Deferred TAs are not as useful to define as they are not readily available in the SULT for calculations as only terms of 10 and 20 are provided.
...
<!-- Self Made -->
![Geom Assurance](Assets/3.%20Life%20Insurance%20Functions.md/Geom%20Assurance.png){.center}
...
The expression follows similar intuition to the second moment - it is simply a regular EPV expression evaluated at a **different interest rate**.
...
<!-- Self Made -->
![Arithmetic Assurance](Assets/3.%20Life%20Insurance%20Functions.md/Arithmetic%20Assurance.png){.center}
...
Intuitively, it can also be shown to be a **sum of deferred assurances**, each deferred by one period from the previous:
...
<!-- Self Made -->
![Arithmetic Deferred](Assets/3.%20Life%20Insurance%20Functions.md/Arithmetic%20Deferred.png){.center}
...
<!-- Self Made -->
![Increasing Term](Assets/3.%20Life%20Insurance%20Functions.md/Increasing%20Term.png)
...
<!-- Self Made -->
![Decreasing Term](Assets/3.%20Life%20Insurance%20Functions.md/Decreasing%20Term.png)

### **Continuous Assurances**

If increase discretely but pay continously then just use UDD/Claims acc

$(I\bar{A}) = \frac{i}{\delta}$

If increase continuously as well then got problem

$(\bar{I}\bar{A})=(I\bar{A}) - \frac{1}{2} \bar{A}_x$

### **Variable Recursions**

First year only receive 1 still

$$
EPV = vq_x + vpx A_{x+1}|_{i=\frac{1+i}{1+b}-1}
$$

Should start from 2 but it starts at 1
Add one WL to increase it accordingly

$$
EPV = vq_x + vp_x[(IA)_{x+1} + A_{x+1}]
$$
