...
Instead of $A$, $\ddot{a}$ is used to represent annuities. It is intepreted as the present value of a contract where a benefit of 1 is **paid at the beginning of the year** for as long as the **status DOES not fail**.
