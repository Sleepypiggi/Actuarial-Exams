...
A similar simplification can be made for temporary annuities:
...
This is known as the **Woolhouse Approximation**. If the error term is omitted, then it is known as the **2-term Woolhouse Approximation** else it is known as the **3-term Woolhouse Approximation**.
