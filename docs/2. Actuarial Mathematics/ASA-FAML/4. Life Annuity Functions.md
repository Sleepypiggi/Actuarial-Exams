...
The second moment and variance will be covered in a later section.
...
**Guaranteed Life Annuities** covers are whole life annuities with the **benefits in the first $n$ years being guaranteed** - they will be paid out even if the insured dies during this period. Thereafter, benefits will resume to being paid only if the insured remains alive.
...
\begin{aligned}
    ...
    \ddot{a}_{\enclose{actuarial}{K_x+1}} \cdot d &= 1-v^{K_x + 1} \\
    v^{K_x + 1} &= 1 - d \ddot{a}_{\enclose{actuarial}{K_x+1}} \\
    \\
    \text{Let } i = i^*,& \text{where } i^* = (1+i)^2-1,\\
    \\
    (v^{K_x + 1})^2 &=  1 - \frac{i^*}{1+i^*} \ddot{a}_{\enclose{actuarial}{K_x+1}i^*} \\
    (v^{K_x + 1})^2 &=  1 - \frac{(i^2 + 2i)}{(1+i)^2} \ddot{a}_{\enclose{actuarial}{K_x+1}i^*} \\
    (v^{K_x + 1})^2 &=  1 - \left(\frac{(i^2)}{(1+i)^2} + \frac{2i}{(1+i)^2}\right) \ddot{a}_{\enclose{actuarial}{K_x+1}i^*} \\
    (v^{K_x + 1})^2 &= 1 - \left(\left(\frac{i}{(1+i)}\right)^2 + \frac{1}{1+i} \cdot \frac{2i}{1+i}\right) \ddot{a}_{\enclose{actuarial}{K_x+1}i^*} \\
    (v^{K_x + 1})^2 &= 1 -(d^2 + 2vd)\ddot{a}_{\enclose{actuarial}{K_x+1}i^*} \\
    (v^{K_x + 1})^2 &= 1 - (d^2 + 2(1-d)d) \ddot{a}_{\enclose{actuarial}{K_x+1}i^*} \\
    (v^{K_x + 1})^2 &= 1 - (d^2 + 2d -2d^2)\ddot{a}_{\enclose{actuarial}{K_x+1}i^*} \\
    (v^{K_x + 1})^2 &= 1 - (2d - d^2) \ddot{a}_{\enclose{actuarial}{K_x+1}i^*} \\
    E((v^{K_x + 1})^2) &= E(1 - (2d - d^2) \ddot{a}_{\enclose{actuarial}{K_x+1}i^*}) \\
