...
As its name suggests, it assumes that there is a uniform distribution of deaths between ages - people die at a constant rate. From another perspective, the survival function decreases at a constant rate, resulting in a **linear survival function** between ages.
