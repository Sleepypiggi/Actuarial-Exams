...
Premium rates
depends on size of policy and rating factors which gauges the risk level of the insured
obtained via a proposal form > Age, gender, smoking, occupation, hobbies, personal and family health history

May require medical underwriting > checked by doctor

Process of collecting and evaluating information is known as Underwriting
Classify policyholders into broadly homogenous risk categories

Preferred Lives > Low Mortality Risk based on the information
Normal Lives > SLightly riskier but still Insurable at standard rates
Rated > One or more risk factors at raised levels and not acceptable at standard rates but can be insured at a higher premioum
Uninsurable > Too high risk, no price

Split by age gender smoking afterwards

95% normal or preferred
2-3% rated
2-3% uninsurable
...
If not strict then risk of advers selection
PH use information about themselves to make decisions that benefit themselves at the expense of the insurer
...
Utmost Good Faith > withold payout if information declared was false
